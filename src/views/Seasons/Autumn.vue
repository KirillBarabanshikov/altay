<template>
  <div class='main'>
    <div class='video'>
      <transition name='fade' mode='out-in'>
        <div v-if='month === 1' class='markers one'>
          ...
          >
            Слет инструкторов-проводников <br> «Золотой гид Алтая»
          ...
          >
            «Зов тайги» <br> Этап чемпионата Сибири классы новички, <br> любители, профи Moto hard- enduro гонки
          ...
          <div
              ...
              :class="['event_popup left', {out: out}]"
          >
            Всероссийский молодежный театральный фестиваль <br> имени Валерия Золотухина
          ...
          <div
              ...
              :class="['event_popup left', {out: out}]"
          >
            Фестиваль молодежи Алтайского края <br> «АМфест»
    ...
    <div class='footer'>
      <Nav :events-list='eventsList' @back='back' @changeMonth='changeMonth' two/>
    </div>
        ...
        enduro: [
          {
            ...
            content: {
              title: '«Зов тайги» Этап чемпионата Сибири классы новички, любители, профи Moto hard- enduro гонки',
