<template>
  <div class='main'>
    <div class='video'>
      <transition name='fade' mode='out-in'>
        <div v-if='month === 1' class='markers one'>
          ...
          >
            Международный туристический форум <br> «VISIT ALTAI»
          ...
          >
            Фестиваль <br> «Цветение маральника»
        ...
        <div v-else-if='month === 2' class='markers two'>
          <div
              ...
              :class="['event_popup left', {out: out}]"
          >
            Чемпионат Сибири по трофи-рейдам <br> на внедорожниках BERLOGA TROPHY
          ...
          <div
              ...
              :class="['event_popup right', {out: out}]"
          >
            Ежегодная всероссийская акция <br> «Ночь музеев»
        ...
        <div v-else-if='month === 3' class='markers three'>
          ...
          <div
              ...
              :class="['event_popup right', {out: out}]"
          >
            XIV Тягунский лыжный марафон
            <span>23 марта 2024 года</span>
          </div>
        </div>
    ...
    <div class='footer'>
      <Nav :events-list='eventsList' @back='back' @changeMonth='changeMonth' three/>
    </div>
        ...
        berloga: [
          {
            ...
            content: {
              title: 'Чемпионат Сибири по трофи-рейдам на внедорожниках BERLOGA TROPHY',
        ...
        marafon: [
          {
            ...
            content: {
              title: 'XIV Тягунский лыжный марафон ',
              text: 'Спортивно-массовое мероприятие, где участвуют спортсмены Сибири, соревнуясь в лыжных забегах на длинные дистанции. Настоящие марафонские дистанции отправятся покорять только самые опытные и выносливые.',
              where: 'ГЛК «БЕРЛОГА» ст. Тягун Заринский район',
              when: '23 марта 2024 года',
              link: 'https://sib-events.ru/reg/8082/, https://berloga.ski'
            }
          }, {
            id: 2,
